...
let dimension = getComputedStyle(document.documentElement).getPropertyValue('--snakesize');
...
export let totalRows = Math.floor(viewportHeight/(dimension+2));
export let totalCols = Math.floor(viewportWidth/(dimension+2));
