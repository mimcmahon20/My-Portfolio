...
var word = document.querySelector('.immersive')
...
let immersivecontainer = document.querySelector('.immersive-container');


if (window.innerWidth <= 767) { // Check if screen width is less than or equal to 767px (i.e. mobile)
